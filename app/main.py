...
def detections(
    ...
    for finding in analysis["findings"]:
        event = events_by_id.get(finding["event_id"], {})
...
def report(analysis_id: str | None = None, print_view: bool = False) -> str:
    ...
    events_by_id = {event["event_id"]: event for event in selected["events"]}
    counts = {
    ...
    finding_rows = []
    detail_sections = []
    for index, finding in enumerate(selected["findings"], 1):
        event = events_by_id.get(finding["event_id"], {})
